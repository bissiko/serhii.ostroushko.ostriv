...
public class Mouse extends Herbivore {
    ...
    public static final int numMax = getNumMaxHerbivore(TypeHerbivore.MOUSE); //500
    public static final int speedMax = getSpeedMaxHerbivore(TypeHerbivore.MOUSE); //1
    public static final double eatMax = getEatMaxHerbivore(TypeHerbivore.MOUSE); //0.01
    public double weight;
    public static final int[] eatHerbivore = InitParams.eatHerbivoreMouse; //{0, 0, 0, 0, 0, 0, 0, 0, 0, 90};
